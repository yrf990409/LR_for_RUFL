                             ...
                             const emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->eta_lr = emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 4, "eta_lr")),
      &thisId);
  ...
  y->grb_model = emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 12, "grb_model")),
      &thisId);
  ...
  y->print = b_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 15, "print")),
      &thisId);
